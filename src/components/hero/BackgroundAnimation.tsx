...
const BackgroundAnimation: FC<BackgroundAnimationProps> = ({ }) => {
        ...
        <div className="row-span-full col-start-1 col-span-5 sm:col-start-2 sm:col-span-4 md:col-start-3 md:col-span-3 w-5/6">
            ...
            >
                ...
                <defs>
                    ...
                    >
                        <stop offset="0.333333" stopColor={mode === "dark" ? "#FBFBFB" : "#0B0B0B"} />
                        <stop offset="1" stopColor={mode === "dark" ? "white" : "black"} stopOpacity="0" />
                    </radialGradient>
                    <radialGradient
                        id="paint1_radial"
                        cx="0"
